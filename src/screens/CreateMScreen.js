...
import { StyleSheet, Text, View, TextInput, Keyboard, KeyboardAvoidingView, TouchableOpacity, Pressable } from 'react-native';
  ...
  return (
    <KeyboardAvoidingView behavior='padding' style={globalStyle.background}>
      <View style={globalStyle.container}>
        ...
        <Pressable style={keyboardVisible ? styles.messageContainerKeyboardVisible : styles.messageContainerKeyboardInvisible} 
          ...
          <View style={styles.buttons}>
            ...
            <FontAwesome name='send' color={'white'} size={22} style={message.length != 0 ? styles.sendActive : styles.sendDisabled} 
                onPress={handleSend} disabled={message.length==0} />
          </View>
        </Pressable>
